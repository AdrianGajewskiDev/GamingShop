...
namespace GamingShop.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            GamingShop.Service.IEmailSender emailSender,
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var callbackUrl = Url.Page(
                        ...
                        pageHandler: null,
                        values: new { area = "Identity", userId = user.Id, code = _code },
                        protocol: Request.Scheme);

                    await _emailSender.SendVerificationEmailAsync(user, "Confirm your email",
